...
<section class="location-section py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="section-title mb-4"><?= $translations['our_location'] ?? 'Our Location' ?></h2>
                <p class="mb-4">
            ...
            <div class="col-lg-6">
                <div class="location-map">
                    <div class="map-placeholder p-4 text-center bg-white rounded shadow">
                        <i class="map-icon fas fa-map-marked-alt fa-3x mb-3"></i>
...
<style>
    ...
    /* CTA Section */
    .about-cta {
        background: linear-gradient(rgba(191, 189, 184, 0.8), rgba(191, 189, 184, 0.9)),
