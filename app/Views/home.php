...
<section class="hero-section text-center">
    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="hero-subtitle text-uppercase tracking-widest mb-3 fade-up-element">
                    <?= $translations['hero_subtitle'] ?? $companyInfo['hero_subtitle'] ?? 'Crafting Excellence Since 2001' ?>
                </h2>
                <h1 class="hero-title mb-4 fade-up-element">
                    <?= $translations['hero_title'] ?? $companyInfo['hero_title'] ?? 'Premium Furniture Manufacturer' ?>
                </h1>
                <p class="hero-description mx-auto mb-5 fade-up-element">
                    <?= $translations['hero_description'] ?? $companyInfo['hero_description'] ?? 'Specializing in high-quality upholstery and wooden furniture from Jepara' ?>
                </p>
                <div class="hero-buttons fade-up-element">
                    <a href="<?= base_url('download-catalog') ?>" class="btn btn-primary btn-lg mx-2">
                        <?= $translations['download_catalog'] ?? 'Download Catalog' ?>
                    </a>
                    <a href="#contact" class="btn btn-outline-light btn-lg mx-2">
...
<section class="categories-detail-section py-5">
    <div class="container">
        <!-- Upholstery Category -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card text-center p-4">
                            <div class="service-icon mb-3">
                                <i class="<?= $service['icon'] ?? 'fas fa-check-circle' ?> fa-3x"></i>
                            </div>
                            <h5><?= $service['title'] ?></h5>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><i class="fas fa-check-circle me-2"></i> <?= $translations['custom_size'] ?? 'Custom sizes and dimensions' ?></li>
                    <li class="mb-2"><i class="fas fa-check-circle me-2"></i> <?= $translations['material_selection'] ?? 'Material selection consultation' ?></li>
                    <li class="mb-2"><i class="fas fa-check-circle me-2"></i> <?= $translations['design_consultation'] ?? 'Design consultation with experts' ?></li>
                    <li class="mb-2"><i class="fas fa-check-circle me-2"></i> <?= $translations['production_oversight'] ?? 'Production oversight and quality control' ?></li>
                </ul>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Mengambil semua elemen yang memiliki class fade-up-element di dalam Hero
        const animatedElements = document.querySelectorAll('.fade-up-element');
        
        // Memberikan jeda waktu (delay) yang berbeda untuk tiap elemen
        animatedElements.forEach((el, index) => {
            setTimeout(() => {
                el.classList.add('is-visible');
            }, 250 * index); // Teks akan muncul bergantian dengan jeda 250 milidetik
        });
    });
</script>