    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="benefit-card text-center p-4">
                    <div class="benefit-icon mb-3">
                        <i class="fas fa-graduation-cap fa-3x" style="color: #666666;"></i>
                    </div>
            ...
            <div class="col-md-4">
                <div class="benefit-card text-center p-4">
                    <div class="benefit-icon mb-3">
                        <i class="fas fa-heartbeat fa-3x" style="color: #D51C39;"></i>
                    </div>
            ...
            <div class="col-md-4">
                <div class="benefit-card text-center p-4">
                    <div class="benefit-icon mb-3">
                        <i class="fas fa-balance-scale fa-3x" style="color: #C38154;"></i>
                    </div>
            ...
            <div class="row">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button
                                                ...
                                                data-position="<?= $career['title'] ?>"
                                                data-code="<?= $career['job_code'] ?>">

                                                <i class="fas fa-paper-plane me-2"></i>
                                                <?= $translations['apply_now'] ?? 'Apply Now' ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="company-culture">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                <h5 class="mb-3"><i class="fas fa-users me-2 text-primary"></i> <?= $translations['our_culture'] ?? 'Our Culture' ?></h5>
    ...
    <div class="container">
        <div class="cta-content text-center p-5 rounded">
            ...
            <div class="cta-buttons">
                <a href="#open-positions" class="btn btn-primary btn-lg me-3">
...
<style>
    ...
    .positions-section .card-header h5 {
        color: #FFFFFF
    }
    ...
    /* CTA Section */
    .career-cta {
        background: linear-gradient(rgba(191, 189, 184, 0.8), rgba(191, 189, 184, 0.8)),
