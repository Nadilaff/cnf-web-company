...
<body>
    ...
    <!-- <div class="language-switcher" style=" background: linear-gradient(135deg, #222222 80%, #171010 100%);"> -->
    ...
    <style>
        ...
        .language-btn.active {
            background-color: #A4998C !important;
            border-color: #76746e !important;
