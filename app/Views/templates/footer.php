<!-- Footer -->
<footer class="footer py-5" style="background: #1A1A1A">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-3">
                        <i class="fas fa-clock me-2" style="color: #BFBDB8;"></i>
                        <span><?= $companyInfo['working_hours'] ?? 'Monday - Friday: 8:00 AM - 5:00 PM' ?></span>
                    </li>
                    <li>
                        <i class="fas fa-calendar-alt me-2" style="color: #BFBDB8;"></i>
